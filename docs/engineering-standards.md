...
- [ ] Payment truth comes from Stripe webhooks, never the client. The client never confirms a booking; only a verified webhook moves a slot to booked or marks the balance paid. Webhook signatures are verified.
